            ...
            <div className=" z-10 w-full max-w-xl rounded-lg bg-white p-4 shadow-lg">
                ...
                <div className="text-slate-700 flex gap-3">
                    <div className="w-1/3 flex flex-col items-center border rounded-lg p-4 bg-slate-50">
                        ...
                        />
                        <div className=" text-slate-500 mb-1">Mã xe: <span className="font-semibold text-slate-700">{bus.code}</span></div>
                        <div className="text-base font-semibold text-slate-700">Tài xế: {bus.driver || "Không rõ"}</div>
                    </div>
                    {/* khung phải */}
                    <div className="w-2/3 flex flex-col gap-4">
                        <div className="border rounded-lg p-4 bg-slate-50 mb-2">
                            <div className="mb-2">
                                <span className="font-semibold">Biển số:</span> {bus.plate}
                            </div>
                            <div className="mb-2">
                                <span className="font-semibold">Loại xe:</span> Xe buýt {bus.seats} chỗ
                            </div>
                            <div>
